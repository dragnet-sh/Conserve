package com.gemini.energy.presentation.scope.parent.dialog
...
class ScopeDialogFragment : DialogFragment(), Validator.ValidationListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val scopeOptions = arrayOf("Plugload", "HVAC", "Motors", "Lighting")
